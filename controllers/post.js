...
const getAllPost = async (req, res, next) => {
    ...
    try {
        ...
        const postsDataPromise = dbcol.aggregate([
            {
                $match: filter
            },
            {
        ...
        const countTotlaPost = await dbcol.find().count();
...
module.exports = { getAllPost , getPostDetail , addPost , updatePost , deletePost , deletePostImage };
